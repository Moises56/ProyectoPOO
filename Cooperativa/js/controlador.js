...
function verMas(codigoAplicacion){
	var parametros = "codigo_aplicacion="+codigoAplicacion;
	$.ajax({
		...
		dataType:"json",
		success:function(resultado){
			document.location.href = "aplicaciones.php?nombre=" + resultado.nombre + "&descripcion=" +resultado.descripcion+ 
			"&version=" +resultado.version+ "&fecha_publicacion=" +resultado.fecha_publicacion+ "&calificacion=" +resultado.calificacion
			+ "&url=" +resultado.url+ "&tamanio=" +resultado.tamanio_archivo+ "&descripcion=" +resultado.descripcion
			+ "&actualizacion=" +resultado.fecha_actualizacion+ "&desarrollador=" +resultado.nombre_desarrollador+ "&imagenes=" +resultado.url_icono ;
